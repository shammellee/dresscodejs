...
(function(root, factory) {
  ...
  Dresscode = {
    ...
    init: function init() {
      ...
      // Whether or not to automatically parse Dresscode elements and compile a stylesheet lorem ipsum dolor sit amet consectetur
    ...
    dress: function dress() {
      var _nodes = _slice.call(document.querySelectorAll('[data-dresscode]')),
        _ruleset,
        _rule,
        _keys,
        _key,
